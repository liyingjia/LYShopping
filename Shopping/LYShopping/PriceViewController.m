...
-(void)downloadWithUrl:(NSString *)url isRefresh:(BOOL)isRefresh
{
    ...
    if (self.keyWord.length != 0) {
        dict = @{@"pagenumber":[NSString stringWithFormat:@"%ld",self.page],@"pagesize":@"10",@"noStock":@"1",@"searchtext":[NSString stringWithFormat:@"%@",self.keyWord],@"v":@"2.0",@"order":@"3"};
    }else if (self.model.categoryId != NULL) {
        dict = @{@"pagenumber":[NSString stringWithFormat:@"%ld",self.page],@"pagesize":@"10",@"noStock":@"1",@"cid":[NSString stringWithFormat:@"%@",self.brandId],@"v":@"2.0",@"order":@"3"};
    } else {
        dict = @{@"pagenumber":[NSString stringWithFormat:@"%ld",self.page],@"pagesize":@"10",@"noStock":@"1",@"brandid":[NSString stringWithFormat:@"%@",self.brandId],@"v":@"2.0",@"order":@"3"};
    }
